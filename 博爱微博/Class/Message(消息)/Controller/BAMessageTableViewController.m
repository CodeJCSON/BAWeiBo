//
//  BAMessageTableViewController.m
//  博爱微博
//
...
@interface BAMessageTableViewController ()

@end

@implementation BAMessageTableViewController
...
//    [chat setTitleTextAttributes:titleAttr forState:UIControlStateNormal];

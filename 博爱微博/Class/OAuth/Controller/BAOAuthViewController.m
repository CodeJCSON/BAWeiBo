...
@interface BAOAuthViewController () <UIWebViewDelegate>

@end

@implementation BAOAuthViewController
...
//    BALog(@"%@", urlStr);
    ...
    // http://www.baidu.com/?code=04efa0261bac920daeac92d90df32756
...
{
    [BAAccountTool accountWithCode:code success:^{
        // 进入主页或者新特性,选择窗口的根控制器
        [BARootTool chooseRootViewController:BAKeyWindow];

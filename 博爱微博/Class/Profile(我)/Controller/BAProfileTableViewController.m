//
//  BAProfileTableViewController.m
//  博爱微博
//
...
@interface BAProfileTableViewController ()

@end

@implementation BAProfileTableViewController
...
//        [setting setTitleTextAttributes:titleAttr forState:UIControlStateNormal];
